...
def main():
  ...
  for action in actions:
      ...
      with h5py.File( '/media/data/zaveri/CNN/Samples/samples_cmu/'+FLAGS.file, 'r' ) as h5f:
          # expmap_gt = h5f['expmap/gt/' + action + FLAGS.sub_index][40:50, :]
          # expmap_pred = h5f['expmap/preds/' + action + FLAGS.sub_index][:]
          expmap_gt = h5f['/media/data/zaveri/CNN/expmap/gt/' + action+FLAGS.sub_index][1:50, :]
          expmap_pred = h5f['/media/data/zaveri/CNN/expmap/preds/' + action+FLAGS.sub_index][:]
