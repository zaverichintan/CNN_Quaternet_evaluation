...
tf.app.flags.DEFINE_string("file", "CNNAdTrain_GANWEIGHT0.010000_Sampling0.950000WindownLength20-20000.h5", "which file to load")
...
def main():
  ...
  for seed in np.arange(256):
      ...
      for action in actions:
          ...
          # ob = viz.Ax3DPose(ax)
          #
          # path="/media/data/zaveri/CNN/samples/"+FLAGS.file+'gt_'+str(seed) +'/'+action
